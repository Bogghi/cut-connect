...
$app->group(BASE_ROUTE.'/reservation', function(RouteCollectorProxy $group) {
    ...
    $group->post('/update', ReservationController::class . ':updateReservation');
    $group->post('/payment', ReservationController::class . ':performPayment');
...
$app->group(BASE_ROUTE.'/service', function(RouteCollectorProxy $group) {
    ...
    $group->post('/update', ServicesController::class . ':updateService');
